  ...
  return (
    <div className="grid gap-4 md:grid-cols-3 w-full">
      ...
      <BlurFade direction="up" delay={0.2}>
        <Card className="group relative border border-neutral-800/80 bg-gradient-to-br from-neutral-900 to-neutral-950 overflow-hidden transition-all duration-300 hover:border-blue-500/20 hover:shadow-md hover:shadow-blue-500/5 p-4 h-[160px] flex flex-col">
          ...
          <CardHeader className="p-0 relative z-10 space-y-0">
            <CardTitle className="text-base text-neutral-100 flex items-center gap-2">
              <div className="flex items-center justify-center bg-blue-500/10 p-2 rounded-lg">
                <svg
                  width="16"
                  height="20"
                  viewBox="0 0 16 20"
      ...
      <BlurFade direction="up" delay={0.3}>
        <Card className="group relative border border-neutral-800/80 bg-gradient-to-br from-neutral-900 to-neutral-950 overflow-hidden transition-all duration-300 hover:border-green-500/20 hover:shadow-md hover:shadow-green-500/5 p-4 h-[160px] flex flex-col">
          ...
          <CardHeader className="p-0 relative z-10 space-y-0">
            <CardTitle className="text-base text-neutral-100 flex items-center gap-2">
              <div className="flex items-center justify-center bg-green-500/10 p-2 rounded-lg">
                <svg
                  width="22"
                  height="21"
                  viewBox="0 0 22 21"
      ...
      <BlurFade direction="up" delay={0.4}>
        <Card className="group relative border border-neutral-800/80 bg-gradient-to-br from-neutral-900 to-neutral-950 overflow-hidden transition-all duration-300 hover:border-purple-500/20 hover:shadow-md hover:shadow-purple-500/5 p-4 h-[160px] flex flex-col">
          ...
          <CardHeader className="p-0 relative z-10 space-y-0">
            <CardTitle className="text-base text-neutral-100 flex items-center gap-2">
              <div className="flex items-center justify-center bg-purple-500/10 p-2 rounded-lg">
                <svg
                  width="18"
                  height="20"
                  viewBox="0 0 18 20"
