    ...
    <div className="w-full px-4 py-8 mt-auto">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid gap-4 md:grid-cols-3 w-full">
          ...
          {/* Info Box 2 */}
          <Card className="group relative border border-neutral-800/80 bg-gradient-to-br from-neutral-900 to-neutral-950 overflow-hidden transition-all duration-300 hover:border-green-500/20 hover:shadow-md hover:shadow-green-500/5 p-4">
          ...
          {/* Info Box 3 */}
          <Card className="group relative border border-neutral-800/80 bg-gradient-to-br from-neutral-900 to-neutral-950 overflow-hidden transition-all duration-300 hover:border-purple-500/20 hover:shadow-md hover:shadow-purple-500/5 p-4">
